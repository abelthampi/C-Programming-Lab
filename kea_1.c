/* C program to implement the following operations using functions:

1. Read two matrices from the user.
2. Perform matrix addition.
3. Display the resultant matrix.
4. Use separate functions for reading, addition, and displaying the matrices. */
